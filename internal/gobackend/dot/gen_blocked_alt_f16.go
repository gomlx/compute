...
// - Base source file (edit this one): blocked_alt_base.go
...
import (
	//alt:base|bf16 "github.com/gomlx/compute/dtypes/bfloat16"
...
//
//alt:base func copyOutputBlockToFlat[T interface {
//alt:base gobackend.PODNumericConstraints | bfloat16.BFloat16 | float16.Float16
//alt:base }](
//alt:bf16  func copyOutputBlockToFlatF32ToBF16(
func copyOutputBlockToFlatF32ToF16( //alt:f16
...
//
//alt:base func buildDotGeneralKernel[T gobackend.PODNumericConstraints](
