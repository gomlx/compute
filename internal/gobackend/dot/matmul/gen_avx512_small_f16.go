...
func avx512SmallFloat16( //alt:f16
	...
	{ //alt:f32|bf16|f16|f64
		if AVX512UseAsm { //alt:f32|bf16|f16|f64
			...
			avx512SmallFloat16NonTransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, rhsCrossSize, contractingSize, output) //alt:f16
...
func avx512SmallFloat16Transposed( //alt:f16
	...
	{ //alt:f32|bf16|f16|f64
		if AVX512UseAsm { //alt:f32|bf16|f16|f64
			...
			avx512SmallFloat16TransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, rhsCrossSize, contractingSize, output) //alt:f16
