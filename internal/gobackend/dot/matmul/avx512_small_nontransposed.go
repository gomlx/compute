...
func avx512SmallFloat32NonTransposedAsm( //alt:f32
	//alt:bf16 func avx512SmallBFloat16NonTransposedAsm(
	//alt:f16 func avx512SmallFloat16NonTransposedAsm(
	...
	if rhsCrossSize == 1 {
		avx512SmallFloat32TransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, 1, contractingSize, output) //alt:f32
		//alt:bf16 avx512SmallBFloat16TransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, 1, contractingSize, output)
		//alt:f16 avx512SmallFloat16TransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, 1, contractingSize, output)
	...
	if rhsCrossSize < vecWidth {
		...
		for b := range batchCount {
			...
			avx512SmallFloat32TransposedAsm(lhsSlice, rhsT, 0, 1, lhsCrossSize, rhsCrossSize, contractingSize, outSlice) //alt:f32
			//alt:bf16 avx512SmallBFloat16TransposedAsm(lhsSlice, rhsT, 0, 1, lhsCrossSize, rhsCrossSize, contractingSize, outSlice)
			//alt:f16 avx512SmallFloat16TransposedAsm(lhsSlice, rhsT, 0, 1, lhsCrossSize, rhsCrossSize, contractingSize, outSlice)
	...
	for range batchCount {
		...
		for ; row+3 < lhsCrossSize; row += 4 {
			...
			for ; col+63 < rhsCrossSize; col += 64 { //alt:f32|bf16|f16
				...
				avx512SmallNonTransposedTile4x64Float32Asm( //alt:f32
					//alt:bf16 avx512SmallNonTransposedTile4x64BFloat16Asm(
					//alt:f16 avx512SmallNonTransposedTile4x64Float16Asm(
			...
			for ; col+15 < rhsCrossSize; col += 16 { //alt:f32|bf16|f16
				...
				avx512SmallNonTransposedTile4x16Float32Asm( //alt:f32
					//alt:bf16 avx512SmallNonTransposedTile4x16BFloat16Asm(
					//alt:f16 avx512SmallNonTransposedTile4x16Float16Asm(
					lRow0, lRow1, lRow2, lRow3, //alt:f32|bf16|f16
					rhsCol, //alt:f32|bf16|f16
					contractingSize, //alt:f32|bf16|f16
					rowStrideBytes, //alt:f32|bf16|f16
