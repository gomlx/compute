		...
		for range batchCount {
			...
			for ; row+3 < lhsCrossSize; row += 4 {
				...
				for ; k+1 < contractingSize; k += 2 {
					//alt:generic la0 := *(*I)(unsafe.Pointer(l0Idx))
					//alt:generic la1 := *(*I)(unsafe.Pointer(l0Idx + iSize))
					//alt:generic lb0 := *(*I)(unsafe.Pointer(l1Idx))
					//alt:generic lb1 := *(*I)(unsafe.Pointer(l1Idx + iSize))
					//alt:generic lc0 := *(*I)(unsafe.Pointer(l2Idx))
					//alt:generic lc1 := *(*I)(unsafe.Pointer(l2Idx + iSize))
					//alt:generic ld0 := *(*I)(unsafe.Pointer(l3Idx))
					//alt:generic ld1 := *(*I)(unsafe.Pointer(l3Idx + iSize))

					//alt:generic rk0 := *(*I)(unsafe.Pointer(rIdx))
					//alt:generic rk1 := *(*I)(unsafe.Pointer(rIdx + iSize))

					la0 := (*(*I)(unsafe.Pointer(l0Idx))).Float32()         //alt:half
					la1 := (*(*I)(unsafe.Pointer(l0Idx + iSize))).Float32() //alt:half
					lb0 := (*(*I)(unsafe.Pointer(l1Idx))).Float32()         //alt:half
					lb1 := (*(*I)(unsafe.Pointer(l1Idx + iSize))).Float32() //alt:half
					lc0 := (*(*I)(unsafe.Pointer(l2Idx))).Float32()         //alt:half
					lc1 := (*(*I)(unsafe.Pointer(l2Idx + iSize))).Float32() //alt:half
					ld0 := (*(*I)(unsafe.Pointer(l3Idx))).Float32()         //alt:half
					ld1 := (*(*I)(unsafe.Pointer(l3Idx + iSize))).Float32() //alt:half

					rk0 := (*(*I)(unsafe.Pointer(rIdx))).Float32()         //alt:half
					rk1 := (*(*I)(unsafe.Pointer(rIdx + iSize))).Float32() //alt:half
			...
			for ; row < lhsCrossSize; row++ {
				...
				for range contractingSize {
					//alt:generic la := *(*I)(unsafe.Pointer(lIdx))
					//alt:generic rk := *(*I)(unsafe.Pointer(rIdx))
					la := (*(*I)(unsafe.Pointer(lIdx))).Float32() //alt:half
		...
		for ; row+1 < lhsCrossSize; row += 2 {
			...
			for ; col+3 < rhsCrossSize; col += 4 {
				...
				for ; k+1 < contractingSize; k += 2 {
					...
					//alt:generic r0_0 := *(*I)(unsafe.Pointer(r0Idx))
					//alt:generic r0_1 := *(*I)(unsafe.Pointer(r0Idx + iSize))
					//alt:generic r1_0 := *(*I)(unsafe.Pointer(r1Idx))
					//alt:generic r1_1 := *(*I)(unsafe.Pointer(r1Idx + iSize))
					//alt:generic r2_0 := *(*I)(unsafe.Pointer(r2Idx))
					//alt:generic r2_1 := *(*I)(unsafe.Pointer(r2Idx + iSize))
					//alt:generic r3_0 := *(*I)(unsafe.Pointer(r3Idx))
					//alt:generic r3_1 := *(*I)(unsafe.Pointer(r3Idx + iSize))
					...
					r0_0 := (*(*I)(unsafe.Pointer(r0Idx))).Float32()         //alt:half
					r0_1 := (*(*I)(unsafe.Pointer(r0Idx + iSize))).Float32() //alt:half
					r1_0 := (*(*I)(unsafe.Pointer(r1Idx))).Float32()         //alt:half
					r1_1 := (*(*I)(unsafe.Pointer(r1Idx + iSize))).Float32() //alt:half
					r2_0 := (*(*I)(unsafe.Pointer(r2Idx))).Float32()         //alt:half
					r2_1 := (*(*I)(unsafe.Pointer(r2Idx + iSize))).Float32() //alt:half
					r3_0 := (*(*I)(unsafe.Pointer(r3Idx))).Float32()         //alt:half
					r3_1 := (*(*I)(unsafe.Pointer(r3Idx + iSize))).Float32() //alt:half
		...
		for ; row < lhsCrossSize; row++ {
			...
			for col := 0; col < rhsCrossSize; col++ {
				...
				for ; k+3 < contractingSize; k += 4 {
					//alt:generic la0 := *(*I)(unsafe.Pointer(lIdx))
					//alt:generic la1 := *(*I)(unsafe.Pointer(lIdx + iSize))
					//alt:generic la2 := *(*I)(unsafe.Pointer(lIdx + 2*iSize))
					//alt:generic la3 := *(*I)(unsafe.Pointer(lIdx + 3*iSize))
					//alt:generic rk0 := *(*I)(unsafe.Pointer(rIdx))
					//alt:generic rk1 := *(*I)(unsafe.Pointer(rIdx + iSize))
					//alt:generic rk2 := *(*I)(unsafe.Pointer(rIdx + 2*iSize))
					//alt:generic rk3 := *(*I)(unsafe.Pointer(rIdx + 3*iSize))

					la0 := (*(*I)(unsafe.Pointer(lIdx))).Float32()           //alt:half
					la1 := (*(*I)(unsafe.Pointer(lIdx + iSize))).Float32()   //alt:half
					la2 := (*(*I)(unsafe.Pointer(lIdx + 2*iSize))).Float32() //alt:half
					la3 := (*(*I)(unsafe.Pointer(lIdx + 3*iSize))).Float32() //alt:half
					rk0 := (*(*I)(unsafe.Pointer(rIdx))).Float32()           //alt:half
					rk1 := (*(*I)(unsafe.Pointer(rIdx + iSize))).Float32()   //alt:half
					rk2 := (*(*I)(unsafe.Pointer(rIdx + 2*iSize))).Float32() //alt:half
					rk3 := (*(*I)(unsafe.Pointer(rIdx + 3*iSize))).Float32() //alt:half
