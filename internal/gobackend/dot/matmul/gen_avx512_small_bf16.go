	...
	for range batchCount {
		...
		for ; row+3 < lhsCrossSize; row += 4 {
			for k := 0; k < contractingSize; k++ {
				...
				//alt:f32 outBase0 := outputBase + uintptr((row+0)*rhsCrossSize+col)*oSize
				//alt:f32 outBase1 := outputBase + uintptr((row+1)*rhsCrossSize+col)*oSize
				//alt:f32 outBase2 := outputBase + uintptr((row+2)*rhsCrossSize+col)*oSize
				//alt:f32 outBase3 := outputBase + uintptr((row+3)*rhsCrossSize+col)*oSize
				...
				//alt:f32 o0_0 = l0.MulAdd(r0, o0_0)
				//alt:f32 o1_0 = l1.MulAdd(r0, o1_0)
				//alt:f32 o2_0 = l2.MulAdd(r0, o2_0)
				//alt:f32 o3_0 = l3.MulAdd(r0, o3_0)
