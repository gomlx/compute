...
func avx512SmallBFloat16TransposedAsm( //alt:bf16
	...
	for range batchCount {
		...
		for ; row+3 < lhsCrossSize; row += 4 {
			...
			for ; col+3 < rhsCrossSize; col += 4 {
				...
				avx512SmallTransposedTile4x4BFloat16Asm( //alt:bf16
			...
			for ; col < rhsCrossSize; col++ {
				...
				for k := range contractingSize {
					...
					r0 := (*(*bfloat16.BFloat16)(unsafe.Pointer(rCol + kOffset))).Float32() //alt:bf16
