...
func avx2SmallFloat16NonTransposedAsm( //alt:f16
	...
	if rhsCrossSize == 1 {
		...
		avx2SmallFloat16TransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, 1, contractingSize, output) //alt:f16
	...
	if rhsCrossSize < vecWidth {
		...
		for b := range batchCount {
			...
			avx2SmallFloat16TransposedAsm(lhsSlice, rhsT, 0, 1, lhsCrossSize, rhsCrossSize, contractingSize, outSlice) //alt:f16
	...
	for range batchCount {
		...
		for ; row+3 < lhsCrossSize; row += 4 {
			...
			for ; col+15 < rhsCrossSize; col += 16 { //alt:f32|bf16|f16
				...
				avx2SmallNonTransposedTile4x16Float16Asm( //alt:f16
			...
			for ; col+7 < rhsCrossSize; col += 8 { //alt:f32|bf16|f16
				...
				avx2SmallNonTransposedTile4x8Float16Asm( //alt:f16
					lRow0, lRow1, lRow2, lRow3, //alt:f32|bf16|f16
					rhsCol,                             //alt:f32|bf16|f16
					contractingSize,                    //alt:f32|bf16|f16
					rowStrideBytes,                     //alt:f32|bf16|f16
