...
func avx2SmallFloat16( //alt:f16
	...
	{ //alt:f32|bf16|f16|f64
		if AVX2UseAsm { //alt:f32|bf16|f16|f64
			...
			avx2SmallFloat16NonTransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, rhsCrossSize, contractingSize, output) //alt:f16
...
func avx2SmallFloat16Transposed( //alt:f16
	...
	{ //alt:f32|bf16|f16|f64
		if AVX2UseAsm { //alt:f32|bf16|f16|f64
			...
			avx2SmallFloat16TransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, rhsCrossSize, contractingSize, output) //alt:f16
