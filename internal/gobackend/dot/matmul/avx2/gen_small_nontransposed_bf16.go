...
func avx2SmallBFloat16NonTransposedAsm( //alt:bf16
	...
	if rhsCrossSize == 1 {
		...
		avx2SmallBFloat16TransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, 1, contractingSize, output) //alt:bf16
	...
	if rhsCrossSize < vecWidth {
		...
		for b := range batchCount {
			...
			avx2SmallBFloat16TransposedAsm(lhsSlice, rhsT, 0, 1, lhsCrossSize, rhsCrossSize, contractingSize, outSlice) //alt:bf16
	...
	for range batchCount {
		...
		for ; row+3 < lhsCrossSize; row += 4 {
			...
			for ; col+15 < rhsCrossSize; col += 16 { //alt:f32|bf16|f16
				...
				avx2SmallNonTransposedTile4x16BFloat16Asm( //alt:bf16
			...
			for ; col+7 < rhsCrossSize; col += 8 { //alt:f32|bf16|f16
				...
				avx2SmallNonTransposedTile4x8BFloat16Asm( //alt:bf16
