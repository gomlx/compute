			...
			for mIdx, lhsPanelRowIdx := 0, rowStart; lhsPanelRowIdx < rowEnd; mIdx++ {
				...
				if canDirectOutput {
					...
					if AVX2UseAsm { //alt:f32|bf16|f16|f64
						...
						avx2LargeKernelBFloat16Asm( //alt:bf16
...
func avx2PrepackRHSBFloat16( //alt:bf16
	...
	ref, flatBuf, ok := GetBuffer[bfloat16.BFloat16](backend, totalElements) //alt:bf16
