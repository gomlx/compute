...
func avx2SmallFloat64( //alt:f64
	...
	{ //alt:f32|bf16|f16|f64
		if AVX2UseAsm { //alt:f32|bf16|f16|f64
			...
			avx2SmallFloat64NonTransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, rhsCrossSize, contractingSize, output) //alt:f64
...
func avx2SmallFloat64Transposed( //alt:f64
	...
	{ //alt:f32|bf16|f16|f64
		if AVX2UseAsm { //alt:f32|bf16|f16|f64
			...
			avx2SmallFloat64TransposedAsm(lhs, rhs, batchStart, batchCount, lhsCrossSize, rhsCrossSize, contractingSize, output) //alt:f64
			return                                                                                                               //alt:f32|bf16|f16|f64
		} //alt:f32|bf16|f16|f64
	} //alt:f32|bf16|f16|f64
