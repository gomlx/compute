...
func avx2LargeMatrixSliceFloat16( //alt:f16
	...
	lhs, rhs []float16.Float16, output []float32, //alt:f16
	...
	packedRHS := make([]float16.Float16, params.PanelContractingSize*params.RHSPanelCrossSize) //alt:f16
	...
	packedLHS := make([]float16.Float16, params.LHSPanelCrossSize*params.PanelContractingSize) //alt:f16
...
func avx2LargeKernelFloat16( //alt:f16
	...
	for row := 0; row < lhsPanelHeight; row += 4 {
		...
		for k := 0; k < contractingPanelWidth; k++ {
			...
			l0 := archsimd.BroadcastFloat32x8((*(*float16.Float16)(unsafe.Pointer(l_base))).Float32())     //alt:f16
			l1 := archsimd.BroadcastFloat32x8((*(*float16.Float16)(unsafe.Pointer(l_base + 2))).Float32()) //alt:f16
			l2 := archsimd.BroadcastFloat32x8((*(*float16.Float16)(unsafe.Pointer(l_base + 4))).Float32()) //alt:f16
			l3 := archsimd.BroadcastFloat32x8((*(*float16.Float16)(unsafe.Pointer(l_base + 6))).Float32()) //alt:f16
			...
			r0, r1 := float16.LoadFloat16x16((*[16]float16.Float16)(unsafe.Pointer(r_base))).ToFloat32() //alt:f16
