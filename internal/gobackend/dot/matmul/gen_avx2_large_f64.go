...
func avx2LargeMatrixSliceFloat64( //alt:f64
	...
	lhs, rhs, output []float64, //alt:f64
	...
	packedRHS := make([]float64, params.PanelContractingSize*params.RHSPanelCrossSize) //alt:f64
	...
	packedLHS := make([]float64, params.LHSPanelCrossSize*params.PanelContractingSize) //alt:f64
	//alt:f32|bf16|f16 packedOutput := make([]float32, params.LHSPanelCrossSize*params.RHSL1KernelCols)
	packedOutput := make([]float64, params.LHSPanelCrossSize*params.RHSL1KernelCols) //alt:f64
...
func avx2LargeKernelFloat64( //alt:f64
	...
	packedLHS, packedRHS, packedOutput []float64, //alt:f64
	...
	for row := 0; row < lhsPanelHeight; row += 4 {
		...
		for k := 0; k < contractingPanelWidth; k++ {
			...
			l0 := archsimd.BroadcastFloat64x4(*(*float64)(unsafe.Pointer(l_base)))      //alt:f64
			l1 := archsimd.BroadcastFloat64x4(*(*float64)(unsafe.Pointer(l_base + 8)))  //alt:f64
			l2 := archsimd.BroadcastFloat64x4(*(*float64)(unsafe.Pointer(l_base + 16))) //alt:f64
			l3 := archsimd.BroadcastFloat64x4(*(*float64)(unsafe.Pointer(l_base + 24))) //alt:f64

			// Load RHS: 16 values (2 YMM registers)
			//alt:f32|bf16|f16 r_base := rhsPtr + uintptr(k*16)*unsafe.Sizeof(packedRHS[0])
			r_base := rhsPtr + uintptr(k*8)*unsafe.Sizeof(packedRHS[0]) //alt:f64
			...
			r0 := archsimd.LoadFloat64x4((*[4]float64)(unsafe.Pointer(r_base)))      //alt:f64
			r1 := archsimd.LoadFloat64x4((*[4]float64)(unsafe.Pointer(r_base + 32))) //alt:f64
		...
		//alt:f32|bf16|f16 o_base := uintptr(row*16) * unsafe.Sizeof(packedOutput[0])
		o_base := uintptr(row*8) * unsafe.Sizeof(packedOutput[0]) //alt:f64
		outputPtr := uintptr(unsafe.Pointer(unsafe.SliceData(packedOutput))) + o_base
		//alt:f32|bf16|f16 o0_0.Store((*[8]float32)(unsafe.Pointer(outputPtr)))
		//alt:f32|bf16|f16 o0_1.Store((*[8]float32)(unsafe.Pointer(outputPtr + 32)))
		//alt:f32|bf16|f16 o1_0.Store((*[8]float32)(unsafe.Pointer(outputPtr + 64)))
		//alt:f32|bf16|f16 o1_1.Store((*[8]float32)(unsafe.Pointer(outputPtr + 96)))
		//alt:f32|bf16|f16 o2_0.Store((*[8]float32)(unsafe.Pointer(outputPtr + 128)))
		//alt:f32|bf16|f16 o2_1.Store((*[8]float32)(unsafe.Pointer(outputPtr + 160)))
		//alt:f32|bf16|f16 o3_0.Store((*[8]float32)(unsafe.Pointer(outputPtr + 192)))
		//alt:f32|bf16|f16 o3_1.Store((*[8]float32)(unsafe.Pointer(outputPtr + 224)))
		o0_0.Store((*[4]float64)(unsafe.Pointer(outputPtr)))       //alt:f64
		o0_1.Store((*[4]float64)(unsafe.Pointer(outputPtr + 32)))  //alt:f64
		o1_0.Store((*[4]float64)(unsafe.Pointer(outputPtr + 64)))  //alt:f64
		o1_1.Store((*[4]float64)(unsafe.Pointer(outputPtr + 96)))  //alt:f64
		o2_0.Store((*[4]float64)(unsafe.Pointer(outputPtr + 128))) //alt:f64
		o2_1.Store((*[4]float64)(unsafe.Pointer(outputPtr + 160))) //alt:f64
		o3_0.Store((*[4]float64)(unsafe.Pointer(outputPtr + 192))) //alt:f64
		o3_1.Store((*[4]float64)(unsafe.Pointer(outputPtr + 224))) //alt:f64
	}
}
