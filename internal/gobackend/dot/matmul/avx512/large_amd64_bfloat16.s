...
//     accumulate bool)
TEXT ·avx512LargeKernelBFloat16Asm(SB), NOSPLIT, $0-120
...
loop_rhs_bf16:
	...
	// 2. Compute lhsPtr and rhsPtr (bfloat16 = 2 bytes)
	// For 8-row LHS strip: strip has 8 bfloat16s = 16 bytes per step.
	...
	// For 32-col RHS strip: strip has 32 bfloat16s = 64 bytes per step.
	...
	// 2 RHS vectors (32 bfloat16s = 64 bytes) converted to float32:
	VPMOVZXWD (DI), Z16
	VPSLLD $16, Z16, Z16
	VPMOVZXWD 32(DI), Z17
	VPSLLD $16, Z17, Z17

	// 8 LHS values (8 bfloat16s = 16 bytes) converted to float32 and broadcast:
	VPMOVZXWD (SI), Y18
	VPSLLD $16, Y18, Y18
