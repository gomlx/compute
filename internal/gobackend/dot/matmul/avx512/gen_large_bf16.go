...
func avx512LargeBFloat16( //alt:bf16
	...
	var cachedRHSPanels, cachedLHSPanels [][]bfloat16.BFloat16 //alt:bf16
	...
	if nodeData != nil {
		if nodeData.PackedRHSCache != nil {
			nodeData.PackedRHSCache.Once.Do(func() {
				...
				ref, panels := avx512PrepackRHSBFloat16(backend, layout, rhs, batchSize, rhsCrossSize, contractingSize, params) //alt:bf16
		...
		if nodeData.PackedLHSCache != nil {
			nodeData.PackedLHSCache.Once.Do(func() {
				...
				ref, panels := avx512PrepackLHSBFloat16(backend, lhs, batchSize, lhsCrossSize, contractingSize, params) //alt:bf16
...
func avx512PrepackRHSBFloat16( //alt:bf16
...
func avx512PrepackLHSBFloat16( //alt:bf16
