...
func TestAVX512TrailingSumCorrectness(t *testing.T) {
	...
	t.Run("Float32", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Float32)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("Float64", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Float64)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("Float16", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Float16)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("BFloat16", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.BFloat16)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("Int32", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Int32)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("Uint32", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Uint32)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("Int16", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Int16)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("Uint16", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Uint16)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("Int8", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Int8)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("Uint8", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Uint8)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("Int64", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Int64)
			requireTrue(t, ok)
			for row := range a {
	...
	t.Run("Uint64", func(t *testing.T) {
		for _, b := range bValues {
			...
			ok := avx512.DispatchTrailingSumAVX512(unsafe.Pointer(&in[0]), unsafe.Pointer(&out[0]), a, b, dtypes.Uint64)
			requireTrue(t, ok)
			for row := range a {
